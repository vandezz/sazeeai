    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div class="bg-gray-900/70 backdrop-blur-sm rounded-2xl border border-gray-700/60 shadow-xl shadow-black/40 overflow-hidden">
            ...
            <form @submit.prevent="generate()" class="divide-y divide-gray-800/70">
                ...
                <!-- SECTION 0: Template Cepat -->
                <div class="px-6 pt-6 pb-5 bg-indigo-950/40">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h3 class="text-base font-bold text-white">Mulai dengan Template</h3>
                            <p class="text-xs text-indigo-300">Pilih template dan semua field akan otomatis terisi — bisa diubah sesuka hati</p>
                        </div>
                    </div>
                    <div class="flex gap-2">
                        <select x-model="selectedPreset" @change="applyPreset()" class="form-input flex-1">
                            <option value="">— Pilih Template Cepat —</option>
                            <option value="jualan-produk-digital">🛒 Jualan Produk Digital</option>
                            <option value="jualan-ebook">📚 Jualan Ebook</option>
                            <option value="flyer-ramadhan">🌙 Flyer Ramadhan</option>
                            <option value="flyer-pendidikan">🎓 Flyer Pendidikan / Kursus</option>
                            <option value="promosi-jasa">✨ Promosi Jasa / Freelance</option>
                            <option value="flash-sale">⚡ Flash Sale / Diskon Besar</option>
                        </select>
                        <button type="button" x-show="selectedPreset" @click="resetForm()" x-cloak
                                class="px-3 py-2 text-xs text-gray-400 hover:text-white border border-gray-700 hover:border-gray-500 rounded-lg transition-all whitespace-nowrap"
                                title="Reset semua field">
                            Reset
                        </button>
                    </div>
                    <p x-show="selectedPreset" x-cloak
                       class="mt-2 text-xs text-indigo-400 flex items-center gap-1.5">
                        ...
                        Template berhasil diterapkan! Kamu bisa mengubah isian sesuai kebutuhanmu.
                    </p>
                </div>
...
function promptGenerator() {
    return {
        form: {
            ...
            lighting_style: '',
            additional_notes: '',
            template_slug: '<?= ! empty($templates) ? esc($templates[0]['slug'] ?? 'premium-advertising-flyer') : 'premium-advertising-flyer' ?>',
        },
        result: '',
        loading: false,
        errors: {},
        ...
        presets: {
            'jualan-produk-digital': {
                brand_name: 'DigiCreative Studio',
                product_name: 'Paket Template Canva Premium',
                headline: 'Desain Profesional dalam Hitungan Menit!',
                subheadline: '100+ Template Canva Siap Edit, Cocok untuk Semua Bisnis',
                product_description: 'Paket template Canva premium berisi 100+ desain siap pakai untuk konten media sosial, banner iklan, presentasi, dan promosi bisnis. Resolusi tinggi, mudah diedit, lisensi komersial.',
                features: 'Template Instagram, Reels & Stories\nBanner Iklan Facebook & Google\nPresentasi & Pitch Deck\nLifetime Access + Update Gratis\nFormat Canva & PSD',
                cta_text: 'Dapatkan Sekarang – Hanya Rp 97.000!',
                target_audience: 'Content creator, pebisnis online, UMKM usia 20–40 tahun',
                image_count: '2',
                image_position: 'Right',
                design_style: 'Vibrant Pop Art',
                color_theme: 'Vibrant Multi-Color',
                aspect_ratio: '1:1 (Square)',
                ai_platform: 'ideogram',
                image_mood: 'Energetic',
                typography_style: 'Bold Display',
                lighting_style: 'High Key',
                additional_notes: 'Tampilkan mockup laptop atau tablet dengan template yang terbuka. Teks harga harus terlihat jelas dan menonjol.',
            },
            'jualan-ebook': {
                brand_name: 'KnowledgeHub ID',
                product_name: 'Ebook: Rahasia Sukses Bisnis Online dari Nol',
                headline: 'Mulai Bisnis Online-mu dari Nol!',
                subheadline: 'Panduan Lengkap 200+ Halaman – Dari Ide Hingga Profit',
                product_description: 'Ebook komprehensif berisi strategi bisnis online yang sudah terbukti menghasilkan profit. Ditulis oleh praktisi berpengalaman 10 tahun di industri digital.',
                features: '200+ halaman konten eksklusif\nStrategi Marketing Digital terbukti\nTemplate business plan & keuangan\nBonus: Checklist harian bisnis online\nAkses seumur hidup',
                cta_text: 'Beli Sekarang Rp 149.000 – Bonus Eksklusif!',
                target_audience: 'Pemula bisnis online, karyawan yang ingin resign, ibu rumah tangga usia 20–45',
                image_count: '1',
                image_position: 'Center',
                ...
                additional_notes: 'Tampilkan mockup ebook di tablet atau e-reader. Latar belakang clean dan minimalis, kesan premium dan terpercaya.',
            },
            'flyer-ramadhan': {
                brand_name: 'Toko Berkah Ramadan',
                product_name: 'Promo Spesial Ramadan 2025',
                headline: 'Promo Berkah Ramadan! Diskon Hingga 50%',
                subheadline: 'Sambut Ramadan dengan Penawaran Terbaik Sepanjang Tahun',
                product_description: 'Promo spesial menyambut bulan suci Ramadan. Dapatkan diskon besar untuk semua produk pilihan, hadiah menarik, dan gratis ongkir ke seluruh Indonesia.',
                features: 'Diskon hingga 50% semua produk pilihan\nGratis ongkir seluruh Indonesia\nBonus hadiah pembelian di atas Rp 200.000\nBerlaku sepanjang bulan Ramadan\nBisa bayar transfer atau COD',
                cta_text: 'Belanja Sekarang – Stok Terbatas!',
                target_audience: 'Muslim Indonesia, keluarga, semua kalangan usia 20–50 tahun',
                image_count: '2',
                image_position: 'Center',
                design_style: 'Cinematic Luxury',
                color_theme: 'Gold & Black',
                aspect_ratio: '9:16 (Story)',
                ai_platform: 'midjourney',
                image_mood: 'Luxurious',
                typography_style: 'Elegant Serif',
                lighting_style: 'Golden Hour',
                additional_notes: 'Gunakan ornamen islami: bulan sabit, bintang, lampu gantung, dan pola arabesque. Suasana hangat dan spiritual. Warna emas dan hitam mendominasi.',
            },
            'flyer-pendidikan': {
                brand_name: 'EduPro Academy',
                product_name: 'Kelas Online Digital Marketing Masterclass',
                headline: 'Kuasai Digital Marketing & Raih Penghasilan Online!',
                subheadline: 'Kelas Intensif 30 Hari bersama Mentor Berpengalaman',
                product_description: 'Program kelas online intensif digital marketing selama 30 hari. Belajar dari nol hingga mahir dengan kurikulum terkini, dipandu mentor yang telah membantu lebih dari 1000 alumni sukses.',
                features: '30 modul video HD akses seumur hidup\nSesi 1-on-1 mentoring langsung\nSertifikat digital resmi\nGrup diskusi eksklusif anggota\nBonus: Template iklan & konten siap pakai',
                cta_text: 'Daftar Sekarang – Early Bird Rp 299.000!',
                target_audience: 'Pelajar, fresh graduate, profesional yang ingin upskilling, usia 18–35',
                image_count: '1',
                image_position: 'Left',
                ...
                typography_style: 'Modern Sans-Serif',
                lighting_style: 'Studio Lighting',
                additional_notes: 'Tampilkan suasana belajar online, laptop, atau ilustrasi akademik yang modern. Kesan profesional, terpercaya, dan penuh semangat.',
            },
            'promosi-jasa': {
                brand_name: 'CreativeWorks Studio',
                product_name: 'Jasa Desain Grafis Profesional',
                headline: 'Desain Brandingmu, Kami yang Wujudkan!',
                subheadline: 'Logo, Banner, Konten Sosmed – Hasil Cepat & Profesional',
                product_description: 'Jasa desain grafis profesional untuk UMKM dan bisnis online. Pengerjaan cepat, revisi unlimited, dan hasil yang memuaskan dengan harga terjangkau.',
                features: 'Logo & Brand Identity lengkap\nDesain konten media sosial\nBanner & Flyer promosi\nRevisi unlimited hingga puas\nFile source + format print-ready',
                cta_text: 'Chat WhatsApp Sekarang – Konsultasi Gratis!',
                target_audience: 'UMKM, startup, pebisnis online yang butuh branding profesional usia 25–45',
                image_count: '2',
                image_position: 'Right',
                design_style: 'Minimalist Modern',
                ...
                typography_style: 'Modern Sans-Serif',
                lighting_style: 'Studio Lighting',
                additional_notes: 'Tampilkan workspace kreatif atau portofolio desain yang elegan. Kesan modern, bersih, dan sangat profesional.',
            },
            'flash-sale': {
                brand_name: 'ShopBest Indonesia',
                product_name: 'Flash Sale 24 Jam – Diskon Gila-gilaan',
                headline: 'FLASH SALE 24 JAM – Diskon Gila-gilaan!',
                subheadline: 'Harga Terendah Sepanjang Masa – Jangan Sampai Ketinggalan!',
                product_description: 'Flash sale 24 jam dengan diskon terbesar yang pernah ada. Berbagai produk pilihan dengan harga yang tidak akan kamu temukan di tempat lain.',
                features: 'Diskon hingga 70% untuk 500+ produk\nGratis ongkir tanpa minimum pembelian\nVoucher tambahan senilai Rp 50.000\nFlash deal baru tiap 2 jam\nGaransi harga terbaik atau uang kembali',
                cta_text: 'BELI SEKARANG – Berakhir Dalam 24 Jam!',
                target_audience: 'Semua kalangan, pemburu diskon, belanja online usia 18–45',
                image_count: '3',
                image_position: 'Center',
                design_style: 'Vibrant Pop Art',
                color_theme: 'Red & Black',
                aspect_ratio: '1:1 (Square)',
                ai_platform: 'ideogram',
                image_mood: 'Energetic',
                typography_style: 'Bold Display',
                lighting_style: 'Neon Glow',
                additional_notes: 'Gunakan elemen countdown timer, ikon kilat atau petir, dan nuansa urgency yang kuat. Warna merah menyala dengan hitam kontras. Teks besar, tebal, dan mencolok.',
            },
        },

        applyPreset() {
            if (!this.selectedPreset || !this.presets[this.selectedPreset]) return;
            const preset = this.presets[this.selectedPreset];
            Object.keys(preset).forEach(key => { this.form[key] = preset[key]; });
        },
        ...
        resetForm() {
            ...
            this.form.headline = '';
            this.form.subheadline = '';
            this.form.product_description = '';
            this.form.features = '';
            this.form.cta_text = '';
            this.form.target_audience = '';
            this.form.image_count = '1';
            this.form.image_position = 'Center';
            this.form.design_style = '';
            this.form.color_theme = '';
            this.form.aspect_ratio = '';
            this.form.ai_platform = '';
            this.form.image_mood = '';
            this.form.typography_style = '';
            this.form.lighting_style = '';
